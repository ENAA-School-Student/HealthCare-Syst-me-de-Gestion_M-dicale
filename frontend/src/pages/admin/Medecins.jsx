...
export default function Medecins() {
  ...
  if (loading && medecins.length === 0) return <div className="loading-container"><div className="spinner" /></div>;
    ...
    <div>
      ...
      <div className="card">
        <div className="card-header">
          ...
          <button className="btn btn-primary" onClick={openCreate}><Plus size={16} /> Ajouter Médecin</button>
        </div>
        {medecins.length === 0 ? (
                  ...
                  <tr key={m.id}>
                    ...
                    <td>
                      <div className="flex gap-2">
                        <button className="btn btn-ghost btn-sm" onClick={() => openEdit(m)} title="Modifier"><Pencil size={14} /></button>
                        <button className="btn btn-danger btn-sm" onClick={() => handleDelete(m.id)} title="Supprimer"><Trash2 size={14} /></button>
                      </div>
                    </td>
                  </tr>
                ))}
      ...
      >
        <form id="medecin-form" onSubmit={handleSubmit} style={{ padding: '1rem' }}>
          <div className="form-row">
            ...
            <div className="form-group">
              ...
              <input className="form-input" value={form.specialite} onChange={(e) => setForm({ ...form, specialite: e.target.value })} required />
            </div>
          </div>
          <div className="form-group">
