    ...
    <PageTransition>
      <div>
        <div className="page-header">
          ...
          <button className="btn btn-primary" onClick={(e) => { createRipple(e); openNew(); }}>
        ...
        <Modal
          ...
          footer={
            <div className="flex gap-2" style={{ justifyContent: 'flex-end' }}>
              ...
              <button className="btn btn-primary" onClick={(e) => { createRipple(e); handleCreate(); }} disabled={submitting}>
